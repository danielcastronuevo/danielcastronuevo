...
### 🚀 Sobre mí
- 🔭 **Experiencia:** 5 años en desarrollo Full Stack, infraestructura y soporte IT avanzado.
- 🛡️ **Seguridad:** Especialista en rediseño de ecosistemas digitales seguros y hardening de sistemas.
- 🎓 **Educación:** Estudiante de la Licenciatura en Seguridad Informática en la Universidad Siglo 21.
- ⚙️ **Stack:** Experto en el ecosistema MERN y administración de servidores Linux.
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,ts,html,css,py,php,nodejs,react,express,nextjs,threejs,aws,linux,arch,bash,vim,vscode,visualstudio,docker,mysql,wordpress,npm,postman,vite,raspberrypi,obsidian,sass&perline=9" />
  </a>
</p>
